export const CATEGORY_GROUP_DESCRIPTIONS: Record<string, string> = {
  ...
  'Dispositivos de Treinamento': 'Materiais didáticos para capacitação prática em procedimentos LOTO.',
};

export const SUBCATEGORY_GROUP_DESCRIPTIONS: Record<string, string> = {
  'Extensores Industriais': 'Soluções para estender o alcance e afastar as mãos da zona de perigo.',
  'Proteção de Impacto': 'Dispositivos que protegem as mãos contra impactos e esmagamentos.',
  'Fixação e Ajuste': 'Soluções de fixação e ajuste para uma operação segura.',
  'Movimentação e Transporte': 'Dispositivos para movimentação e transporte de cargas com segurança.',
  'Armazenamento Seguro': 'Soluções para o armazenamento seguro de ferramentas e materiais.',
};
